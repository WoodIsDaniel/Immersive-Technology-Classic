package woodisdaniel.immersivetechnology.client.gui;
...
import woodisdaniel.immersivetechnology.common.gui.DistillerMenu;

public class DistillerScreen extends AbstractContainerScreen<DistillerMenu> {
    private static final ResourceLocation GUI_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(ImmersiveTechnology.MOD_ID, "textures/gui/gui_distiller.png");
