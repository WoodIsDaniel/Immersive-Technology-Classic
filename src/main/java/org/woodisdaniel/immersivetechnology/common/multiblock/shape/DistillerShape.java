package org.woodisdaniel.immersivetechnology.common.multiblock.shape;
...
public class DistillerShape implements Function<BlockPos, VoxelShape>
{
    public static final Function<BlockPos, VoxelShape> SHAPE_GETTER = new DistillerShape();

    private DistillerShape()
    {
    }
